	...
	<div>
		<form action="<%=ORSView.STAFF_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<%=HTMLUtility.getList("division", String.valueOf(dto.getDivision()), map)%>
				</div>
				<div class="col-sm-2">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" name="previousEmployer"
						class="p1" placeholder="Enter Previous Employer"
				...
				<table class="table table-dark table-bordered  table-hover">
					...
					<tbody>
						<tr>
							...
							<td align="center"><a href="StaffCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=StaffListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
