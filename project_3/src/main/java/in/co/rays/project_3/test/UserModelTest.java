...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setDob(sdf.parse("18-01-2005"));
		dto.setConfirmPassword("Pass@123");
		dto.setPassword("Pass@123");
		dto.setLogin("Luckytomar@gmail.com");
		dto.setGender("male");
		...
		dto.setRoleId(1);
		dto.setMobileNo("7697687749");
		dto.setRegisteredIP("Luckytomar@gmail.com");
		dto.setLoginIP("Luckytomar@gmail.com");
